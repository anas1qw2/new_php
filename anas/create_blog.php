...
// Define $is_admin variable based on the session role
...
<main class="container mx-auto p-6">
    ...
    <!-- Blog Creation Form -->
    <form method="POST" action="create_blog.php" enctype="multipart/form-data" class="bg-white p-4 rounded shadow-md mb-6">
